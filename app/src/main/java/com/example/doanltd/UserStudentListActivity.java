...
public class UserStudentListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listStudentAdapter = new ArrayAdapter<>(UserStudentListActivity.this, android.R.layout.simple_list_item_1, listStudent);
    ...
    public void goToStudentDetailActivity(View view) {
        Intent intent = new Intent(this, UserStudentDetailActivity.class);
